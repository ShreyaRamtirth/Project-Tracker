...
function createproject() {
  ...
  return (
    ...
    <ToastContainer />
      ...
      <div className={styles.projectHeading}>Create Project<hr /></div> 
      <div className={styles.projectTitle}>
      <table >
  <tbody>
  <tr>
    <td>
            <label>Enter Title </label> </td>
        <td> <input type="text" className={styles.projectInput}  size="42"
         
         data-tip="Should contain only charaters" onChange={fnameValidation}  />
         {fnameErr ? "" : <p className={styles.error}>Invalid Company Name</p>}    
        ...
        <tr>
    <td>
            <label className={styles.techLabels}>Technologies</label> </td>
            <td>
            <ReactTagInput 
      tags={tags} 
    ...
    />
      ...
      <td>
        <label className={styles.projectDescTitle}>Description </label></td><td>
                <textarea
                  cols="100"
                  rows="5"
                  className={styles.projectInput}
                  data-tip="Should contain only charaters and numbers" onChange={lnameValidation}  />
                  {lnameErr ? "" : <p className={styles.error}>Invalid Description Name</p>}    
                  {mount && <ReactTooltip place="right" type="info" effect="float" 
                      multiline={true} 
                      /> } 
             </td>
            ...
            <tr><td>
                <label className={styles.deadlineLabel}>Deadline</label> </td> <td>
                <input
                  type="date" size="42" className={styles.projectInput}
                  data-tip="Date should be in future" onChange={dateValidation}  />
                  {deadlineErr ? "" : <p className={styles.error}>Invalid Date</p>}    
                  {mount && <ReactTooltip place="right" type="info" effect="float" 
                      multiline={true} 
                      /> } 
              </td>
        ...
        <option value="meat">Meat</option> */}
              ...
              <tr>
                <td>
                <label className={styles.projectCost}>Cost</label></td> <td>
                <CurrencyFormat className={styles.projectInput} thousandSeparator={true}  prefix={'₹'} 
                size="42"
                onChange={(e) => {     
                setCost(Number((e.target.value).replace(/[^0-9.-]+/g,"")))
                }}
                /> </td>
          </tr>
</tbody>
